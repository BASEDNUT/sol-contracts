...
import {MockUSDC, MockERC20, MockPair, MockPipsBuyer, MockSwapRouter, MockLpRouter} from "../mocks/Mocks.sol";
...
contract BaseForkTest is Test {
    ...
    function setUp() public {
        ...
        bytes32 pipsUID = ISchemaRegistry(SCHEMA_REGISTRY).register(pipsDef, ISchemaResolver(address(0)), false);
        bytes32 lpUID = ISchemaRegistry(SCHEMA_REGISTRY).register(lpDef, ISchemaResolver(address(0)), false);
    ...
    function test_RealEas_ConstructorAndAttestation() public {
        ...
        (bytes32 p, bytes32 l) = router.splitAndDeploy(100e6, 150e18, 55e18, 29e18, 29e18, 8e26, block.timestamp + 1800);
